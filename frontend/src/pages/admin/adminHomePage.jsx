  ...
  return (
    <div className="h-screen w-full flex flex-col">
      ...
      <div className="h-[100px] w-full bg-white flex flex-row items-center justify-center fixed shadow-xl">
        <h1>
          <CgProfile className="mr-20 text-[50px]" />
        </h1>
      ...
      <div className="h-[calc(100vh-100px)] w-full flex flex-row">
        ...
        <div className="h-screen w-[100px] bg-white flex flex-col items-center text-[40px]  fixed">
          <Link to="/admin/item">
            <AiOutlineProduct
              className="hover:text-[#a24af8] hover:animate-spin mt-8 shadow-xl rounded-lg bg-gray-200 p-2 cursor-pointer"
              size={40}
            />
          </Link>
          ...
          <Link to="/admin/userDetails">
            <AiOutlineUser
              className="hover:text-[#a24af8] mt-8 shadow-xl hover:animate-spin rounded-lg bg-gray-200 p-2 cursor-pointer"
              size={40}
            />
          </Link>
          ...
          <Link to="/logout">
            <BiLogOut
              className="hover:text-[#a24af8] mt-8 absolute bottom-10 right-1/3 hover:animate-spin shadow-xl rounded-lg bg-gray-200 p-2 cursor-pointer"
              size={40}
            />
          </Link>
        </div>
